...
<template>
    ...
    <PageHeader :title="'Request Medication'" :items="'Request Medication'" />
    <div class="row">
        <!-- Right Sidebar -->
        <div class="col-12">
            <div class="mb-3">
                <div class="card">
                    <div class="card-body">
                        <div class="btn-toolbar p-3">
                            <div class="d-flex flex-row justify-content-between col-12 mb-4">
                                <div class="d-flex w-100 align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <b-button variant="primary" @click="state.requestMedicationModal = true">Request
                                            Medication</b-button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <b-modal v-model="state.requestMedicationModal" id="requestMedicationModal"
                            ...
                            <div class="mb-5">
                                <div class="text-center fw-bold">Sumit Medical Request</div>
                                <div class="text-center mb-3">You are about to submit a request for medication</div>
                            </div>
                            <div class="mb-3">
                                <simplebar style="max-height: 50vh">
                                    <div>
                                        <div class="col-4 mb-4">
                                            ...
                                            <div class="d-flex flex-row gap-4">
                                                <b-form-checkbox id="customControlInline" name="checkbox-1"
                                                    v-model="state.myself" :disabled="state.makeFormDisabled"
                                                    @click="disableAnother"> My Self
                                                </b-form-checkbox>
                                                <b-form-checkbox id="customControlInline2" name="checkbox-2"
                                                    v-model="state.anotherPerson" :disabled="state.makeFormDisabled"
                                                    @click="disableMyself"> Another Patient
                                                </b-form-checkbox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4 mb-4">
                                            ...
                                            <div class="d-flex flex-row gap-4">
                                                <b-form-checkbox id="customControlInline" name="checkbox-1"
                                                    v-model="state.delivery" :disabled="state.makeFormDisabled"
                                                    @click="disablepickup"> Delivery
                                                </b-form-checkbox>
                                                <b-form-checkbox id="customControlInline2" name="checkbox-2"
                                                    v-model="state.pickup" :disabled="state.makeFormDisabled"
                                                    @click="disableDelivery"> Pick up
                                                </b-form-checkbox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" mb-4">
                                         <div class="weather-map-container">
                                            <GoogleMap
                                                api-key="AIzaSyBQKw2vj3Wjow-0p69Wz8okjJ470gVOhNo"
                                                :center="state.markCenter"
                                                :zoom="16"
                                                :map-type-id="'hybrid'"
