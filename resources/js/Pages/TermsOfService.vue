...
<template>
    ...
    <div class="bg-white">
        <div class="home-btn d-none d-sm-block bg-white">
            <Link :href="route('login')" class="text-dark">
                <i class="fas fa-home h2"></i>
            </Link>
        </div>
        <section class="my-5 pt-sm-5 bg-white">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card mt-4 maintenance-box">
                                        <div class="card-body">
                                            <i
                                                class="bx bx-broadcast mb-4 h1 text-primary"
                                            ></i>
                                            <h5
                                                class="font-size-15 text-uppercase"
                                            >
                                ...
                                <div class="col-md-4">
                                    <div class="card mt-4 maintenance-box">
                                        <div class="card-body">
                                            <i
                                                class="bx bx-time-five mb-4 h1 text-primary"
                                            ></i>
                                            <h5
                                                class="font-size-15 text-uppercase"
                                            >
                                ...
                                <div class="col-md-4">
                                    <div class="card mt-4 maintenance-box">
                                        <div class="card-body">
                                            <i
                                                class="bx bx-envelope mb-4 h1 text-primary"
                                            ></i>
                                            <h5
                                                class="font-size-15 text-uppercase"
                                            >
