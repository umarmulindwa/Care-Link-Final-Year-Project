<template>
        ...
        <div class="tailwind-classes">
            <div class="container">
                <div class="row d-flex">
                    <div class="col-12 card card-body shadow-md">
                        <form>
                            <FormElements>

                                <div class="text-xl mb-4 vf-col-12">
                                ...
                                <RadiogroupElement name="job_type" label="Job type" rules="required"
                                    ...
                                    <template
                                        v-slot:radio="{ items, index, item, value, el$, classes, isDisabled, id, name }">
                                        <div class="flex items-center justify-center border py-1.5 w-full bg-white" :class="{
                                            ...
                                            <input type="radio" v-model="el$.model" :value="value" class="hidden"
                                                :name="name" :id="id" :disabled="isDisabled" />
    ...
    />
                                ...
                                <!-- Job categories -->
                                <TagsElement name="categories" label="Job categories" rules="required|max:3"
                                    description="Select up to 3" :search="true" :items="job_categories" />

                                <!-- Working hours -->
                                <SliderElement name="work_hours" label="Required minimum weekly working hours" :default="20"
                                    :min="1" :max="40" :format="v => v > 1 ? `${Math.round(v)} hours` : '1 hour'"
                                    :add-classes="{
                                        ElementLayout: {
                                            innerWrapper: 'mt-12'
                                        }
                                ...
                                <GroupElement name="salary_settings" label="Payment">
                                    <SelectElement name="has_salary" placeholder="Select" floating="Salary" rules="required"
                                        :native="false" :can-clear="false" :items="{ 1: 'Paid', 0: 'Unpaid' }" :columns="{
                                            xs: 12, sm: 12, md: 3, lg: 3
                                        }" />
                                    <TextElement name="salary" placeholder="Amount" rules="integer" :can-clear="false"
                                        :conditions="[
                                            ['salary_settings.has_salary', 1]
                                        ]" :columns="{
    xs: 12, sm: 12, md: 3, lg: 3
}" />
                                    <SelectElement name="salary_currency" default="usd" :native="false" :can-clear="false"
                                        :items="{
                                            usd: 'USD',
                                            eur: 'EUR'
                                        }" :conditions="[
    ...
    xs: 12, sm: 12, md: 3, lg: 3
                                    ...
                                    <SelectElement name="salary_period" default="weekly" :native="false" :can-clear="false"
                                        :items="{
                                            hourly: '/ hour',
                                            daily: '/ day',
                                            weekly: '/ week',
    ...
    xs: 12, sm: 12, md: 3, lg: 3
                                ...
                                <DateElement name="application_deadline" label="Application deadline" rules="required"
                                    :conditions="[
                                        ['continuous_application', false]
                                    ]" />
                                <CheckboxElement name="continuous_application" text="Can apply continuously"
                                    add-class="-mt-2" />
                                ...
                                <ListElement name="languages" label="Required language skills" :min="1">
                                    <template #default="{ index }">
                                        <ObjectElement :name="index">
                                            <SelectElement name="language_id" placeholder="Language" rules="required"
                                                columns="6" :search="true" :items="langs" />
                                            <SelectElement name="language_level" placeholder="Level" rules="required"
                                                columns="6" :items="{
                                                    25: 'Beginner',
                                                    50: 'Intermediate',
                                                    75: 'Advanced',
                                ...
                                <!-- Degree -->
                                <CheckboxElement name="degree" label="Degree" text="Degree is required for work"
                                    :trueValue="1" :falseValue="0" />
                                <SelectElement name="degree_requirement" placeholder="Degree level" :native="false"
                                    :columns="{
                                        lg: 5, sm: 6
                                    }" :items="{
    50: 'BA/BSc',
    ...
    ['degree', 1]
                                ...
                                <!-- Professional skills -->
                                <TagsElement name="professional_skills" label="Professional skills"
                                    description="Choose as many as you can" :close-on-select="false" :create="true"
                                    :items="professional_skills" />

                                <!-- Computer skills -->
                                <TagsElement name="computer_skills" label="Computer skills"
                                    description="Choose as many as you can" :close-on-select="false" :create="true"
                                    :items="computer_skills" />

                                <!-- Soft skills -->
                                <TagsElement name="soft_skills" label="Competences, soft skills"
                                    description="Choose as many as you can" :close-on-select="false" :create="true"
                                    :items="soft_skills" />
                                ...
                                <GroupElement name="feedback" label="Auto reply message for applicants"
                                    ...
                                    <template #before>
                                        <div class="text-sm text-gray-500 mb-2">
                                            Here you can write messages in advance you would like to send out to applicants
                                            when you
                                ...
                                <TextElement name="external_url" label="Add link" field-name="Link"
                                    placeholder="eg. https://yourcompany.com/job-title" rules="required|url"
                                    add-class="-mt-4" :conditions="[
    ...
    rules: 'required|max:4096'
                                ...
                                <!-- Gallery -->
                                <MultifileElement name="gallery" label="Image gallery (optional)" accept=".jpg, .png, .gif"
                                    view="gallery" rules="max:8" :sort="true" :image="true"
