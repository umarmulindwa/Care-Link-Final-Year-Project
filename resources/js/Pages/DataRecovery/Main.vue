...
<template>
    ...
    <Head title="Data Recovery" />

    <PageHeader :title="'Data Recovery'" :items="'Data Recovery'" />
    <div class="row">
        <!-- Right Sidebar -->
        <div class="col-12">
            <div class="mb-3">
                <div class="card">
                    <div class="card-body">
                        <div class="btn-toolbar p-3">
                            <div class="d-flex flex-row justify-content-between col-12 mb-4">
                                <div class="d-flex w-100 align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <b-button variant="primary" @click="state.requestMedicationModal = true">Show Data Recovery</b-button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mt-3 ">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="d-flex justify-content-center align-items-center flex-column mt-5 mb-5">
                                    ...
                                    <div> You don't have any Health Records</div>
                                </div>
                        ...
                        <b-modal v-model="state.requestMedicationModal" id="requestMedicationModal"
                            ...
                            <div class="mb-5">
                                <div class="text-center fw-bold">Add Data</div>
                                <div class="text-center mb-3">You are about to add data</div>
                            </div>
                            <div class="mb-3">
