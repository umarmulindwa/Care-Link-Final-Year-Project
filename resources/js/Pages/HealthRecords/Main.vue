...
<template>
    ...
    <PageHeader :title="'Health Records'" :items="'Health Records'" />
    <div class="row">
        <!-- Right Sidebar -->
        <div class="col-12">
            <div class="mb-3">
                <div class="card">
                    <div class="card-body">
                        <div class="btn-toolbar p-3">
                            <div class="d-flex flex-row justify-content-between col-12 mb-4">
                                <div class="d-flex w-100 align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <b-button variant="primary" @click="state.requestMedicationModal = true">Add
                                            Health Records</b-button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <b-modal v-model="state.requestMedicationModal" id="requestMedicationModal"
                            ...
                            <div class="mb-5">
                                <div class="text-center fw-bold">Add Medical Record</div>
                                <div class="text-center mb-3">You are about to add a medical record</div>
                            </div>
                            <div class="mb-3">
