                        ...
                        <div class="row">
                            <div class="col-12">
                                <form class="form-horizontal" role="form">
                                    <b-form-group class="mb-3" id="example text" label-cols-lg="2" label="Text" label-for="text">
                                    ...
                                    <b-form-group class="mb-3" id="example-email" label-cols-sm="2" label-cols-lg="2" label="Email" label-for="email">
                                        <b-form-input id="email" value="bootstrap@example.com"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-url" label-cols-sm="2" label-cols-lg="2" label="URL" label-for="url">
                                        <b-form-input id="url" value="https://getbootstrap.com" type="url" name="url"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-tel" label-cols-sm="2" label-cols-lg="2" label="Telephone" label-for="tele">
                                        <b-form-input id="tele" value="1-(555)-555-5555" type="tel" name="tel"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-password" label-cols-sm="2" label-cols-lg="2" label="Password" label-for="pwd">
                                        <b-form-input id="pwd" type="password" value="password"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-number" label-cols-sm="2" label-cols-lg="2" label="Number" label-for="number">
                                        <b-form-input id="number" value="42" type="number" name="number"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-date-time" label-cols-sm="2" label-cols-lg="2" label="Date and time" label-for="date-time">
                                        <b-form-input id="date-time" value="2019-08-19T13:45:00" type="datetime-local"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-date" label-cols-sm="2" label-cols-lg="2" label="Date" label-for="date">
                                        <b-form-input id="date" value="2019-08-19" type="date"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-month" label-cols-sm="2" label-cols-lg="2" label="Month" label-for="month">
                                        <b-form-input id="month" value="2019-08" type="month"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-week" label-cols-sm="2" label-cols-lg="2" label="Week" label-for="week">
                                        <b-form-input id="week" value="2019-W33" type="week"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-time" label-cols-sm="2" label-cols-lg="2" label="Time" label-for="time">
                                        <b-form-input id="time" value="13:45:00" type="time"></b-form-input>
                                    </b-form-group>

                                    <b-form-group class="mb-3" id="example-color" label-cols-sm="2" label-cols-lg="2" label="Color" label-for="color">
                                        <b-form-input class="form-control-color mw-100" id="color" type="color" name="color" value="#556ee6"></b-form-input>
                                    </b-form-group>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <b-form-input id="custom-range" type="range" class="form-range"></b-form-input>

                            <b-form-input id="customRange2" class="mt-4 form-range" type="range" min="0" max="5"></b-form-input>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="mt-4">
                                    <h5 class="font-size-14 mb-4"><i class="mdi mdi-arrow-right text-primary me-1"></i> Form Checkboxes Right</h5>

                                    <div>
                                        <div class="form-check form-check-right mb-3">
                                            <input class="form-check-input" type="checkbox" id="formCheckRight1" />
                                            <label class="form-check-label" for="formCheckRight1"> Form Checkbox Right </label>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="form-check form-check-right">
                                            <input class="form-check-input" type="checkbox" id="formCheckRight2" checked="" />
                                            <label class="form-check-label" for="formCheckRight2"> Form Checkbox Right checked </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-sm-6">
                                <div class="mt-4">
                                    <h5 class="font-size-14"><i class="mdi mdi-arrow-right text-primary me-1"></i> Custom Checkboxes colors</h5>
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check form-check-success mb-3">
                                            <input class="form-check-input" type="checkbox" id="formCheckcolor1" checked="" />
                                            <label class="form-check-label" for="formCheckcolor1"> Checkbox Success </label>
                                        </div>

                                        <div class="form-check form-check-info mb-3">
                                            <input class="form-check-input" type="checkbox" id="formCheckcolor1" checked="" />
                                            <label class="form-check-label" for="formCheckcolor1"> Checkbox Info </label>
                                        </div>

                                        <div class="form-check form-check-warning mb-3">
                                            <input class="form-check-input" type="checkbox" id="formCheckcolor1" checked="" />
                                            <label class="form-check-label" for="formCheckcolor1"> Checkbox Warning </label>
                                        </div>

                                        <div class="form-check form-check-danger mb-3">
                                            <input class="form-check-input" type="checkbox" id="formCheckcolor1" checked="" />
                                            <label class="form-check-label" for="formCheckcolor1"> Checkbox Danger </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-sm-6">
                                <div class="mt-4">
                                    <h5 class="font-size-14"><i class="mdi mdi-arrow-right text-primary me-1"></i> Custom Checkboxes Outline</h5>
                                    <p class="sub-header mb-4">
                                        Add class
                                        <code>.form-checkbox-outline</code> &amp; <code>.form-check-*</code> for a color Checkboxes
                                    </p>
                                    ...
                                    <div>
                                        <div>
                                            <div class="form-check form-checkbox-outline form-check-primary mb-3">
                                                ...
                                                <label class="form-check-label" for="customCheckcolor1"> Checkbox Outline Primary </label>
                                            </div>
                                            ...
                                            <div class="form-check form-checkbox-outline form-check-success mb-3">
                                                ...
                                                <label class="form-check-label" for="customCheckcolor2"> Checkbox Outline Success </label>
                                            </div>
                                            ...
                                            <div class="form-check form-checkbox-outline form-check-info mb-3">
                                                ...
                                                <label class="form-check-label" for="customCheckcolor3"> Checkbox Outline Info </label>
                                            </div>
                                            ...
                                            <div class="form-check form-checkbox-outline form-check-warning mb-3">
                                                ...
                                                <label class="form-check-label" for="customCheckcolor4"> Checkbox Outline Warning </label>
                                            </div>
                                            ...
                                            <div class="form-check form-checkbox-outline form-check-danger">
                                                ...
                                                <label class="form-check-label" for="customCheckcolor5"> Checkbox Outline Danger </label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="mt-4">
                                    <h5 class="font-size-14"><i class="mdi mdi-arrow-right text-primary mr-1"></i> Form Radio colors</h5>
                                    <p class="sub-header mb-4">Add class <code>.form-radio-* </code> for a color Radios</p>

                                    <div>
                                        <div class="form-check form-radio-primary mb-3">
                                            <input class="form-check-input" type="radio" name="formRadioColor1" id="formRadioColor1" checked="" />
                                            <label class="form-check-label" for="formRadioColor1"> Radio Primary </label>
                                        </div>
                                        ...
                                        <div class="form-check form-radio-success mb-3">
                                            ...
                                            <label class="form-check-label" for="formRadioColor2"> Radio Success </label>
                                        </div>
                                        ...
                                        <div class="form-check form-radio-info mb-3">
                                            ...
                                            <label class="form-check-label" for="formRadioColor3"> Radio Info </label>
                                        </div>

                                        <div class="form-check form-radio-warning mb-3">
                                            <input class="form-check-input" type="radio" name="formRadioColor4" id="formRadioColor4" checked="" />
                                            <label class="form-check-label" for="formRadioColor4"> Radio warning </label>
                                        </div>
                                        ...
                                        <div class="form-check form-radio-danger mb-3">
                                            ...
                                            <label class="form-check-label" for="formRadioColor5"> Radio Danger </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-sm-6">
                                <div class="mt-4">
                                    <h5 class="font-size-14"><i class="mdi mdi-arrow-right text-primary mr-1"></i> Form Radio Outline</h5>
                                    <p class="sub-header mb-4">Add class <code>form-radio-outline</code> &amp; <code>.form-radio-* </code> for a color Checkboxes</p>

                                    <div>
                                        <div class="form-check form-radio-outline form-radio-primary mb-3">
                                            <input class="form-check-input" type="radio" name="formRadio1" id="formRadio1" checked />
                                            <label class="form-check-label" for="formRadio1"> Radio Outline Primary </label>
                                        </div>
                                        <div class="form-check form-radio-outline form-radio-success mb-3">
                                            ...
                                            <label class="form-check-label" for="formRadio2"> Radio Outline Success </label>
                                        </div>
                                        <div class="form-check form-radio-outline form-radio-info mb-3">
                                            ...
                                            <label class="form-check-label" for="formRadio3"> Radio Outline Info </label>
                                        </div>
                                        <div class="form-check form-radio-outline form-radio-warning mb-3">
                                            ...
                                            <label class="form-check-label" for="formRadio4"> Radio Outline Warning </label>
                                        </div>
                                        <div class="form-check form-radio-outline form-radio-danger mb-3">
                                            ...
                                            <label class="form-check-label" for="formRadio5"> Radio Outline Danger </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
